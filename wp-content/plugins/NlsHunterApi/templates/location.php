<div class="item-contact clearfix">	
    <div class="right-iframe">
        <a href="https://www.google.com/maps/search/?api=1&query=<?= urlencode($location->post_excerpt) ?>" target="_blank"><img src="<?= get_the_post_thumbnail_url($location->ID) ?>" alt="Contact"></a>
    </div>
    <div class="location">
